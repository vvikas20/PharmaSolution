CREATE TABLE [dbo].[TempPurchaseSaleBookLineItem] (
    ...
    CONSTRAINT [PK_TempPurchaseSaleBookLineItem] PRIMARY KEY CLUSTERED ([PurchaseSaleBookLineItemID] ASC),
    CONSTRAINT [FK_TempPurchaseSaleBookLineItem_FIFO] FOREIGN KEY ([FifoID]) REFERENCES [dbo].[FIFO] ([FifoID]),
    CONSTRAINT [FK_TempPurchaseSaleBookLineItem_TempPurchaseSaleBookHeader] FOREIGN KEY ([PurchaseSaleBookHeaderID]) REFERENCES [dbo].[TempPurchaseSaleBookHeader] ([PurchaseSaleBookHeaderID])
);
